...
![Bottled-in-bond withdrawals and their geographic concentration, FY1898–1920. National bonded withdrawals rise from 0.54 million gallons in FY1898 to 16.51 million in FY1917; Kentucky and Pennsylvania account for the bulk of the volume throughout.](/images/papers/bib_withdrawals.png)

![The certified sub-segment against straight and rectified output: a small tier expanding on top of an existing trade, not a redistribution of it.](/images/papers/bib_subsegment.png)

![The quantity horse-race: rectified output grew at least as fast as straight whiskey after 1897 — the pattern that rejects the foreclosure reading.](/images/papers/bib_horserace.png)
...
::: {.callout-note}
This page is a preview. The full draft — including the common-treatment-date event study, the relabeling test, the legislative and archival record on intent (the committee report, the Aldrich "or owner" amendment, the organized rectifier remonstrances), and the complete robustness battery — is available on request at [jacob.rand.smith@gmail.com](mailto:jacob.rand.smith@gmail.com).
:::
