...
Plot.plot({
  ...
  y: {label: "Bonded whiskey withdrawn (gallons)", grid: true, tickFormat: "~s"},
  color: {legend: true},
  marks: [
    Plot.ruleY([0]),
    ...
    Plot.tip(bibdata, Plot.pointer({x: "fy", y: "bib_gal", channels: {State: "state"}, format: {y: d => d.toLocaleString() + " gal"}}))
  ]
})
```
